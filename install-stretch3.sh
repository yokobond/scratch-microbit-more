...
cp microbitMore/scratch-vm/src/extensions/microbitMore/index.js node_modules/scratch-vm/src/extensions/microbitMore/
...
cp microbitMore/scratch-gui/src/lib/libraries/extensions/microbitMore/microbitMore.png src/lib/libraries/extensions/microbitMore/
cp microbitMore/scratch-gui/src/lib/libraries/extensions/microbitMore/microbitMore-small.svg src/lib/libraries/extensions/microbitMore/
cp microbitMore/scratch-gui/src/lib/libraries/extensions/microbitMore/microbitMore-illustration.svg src/lib/libraries/extensions/microbitMore/
mv src/lib/libraries/extensions/index.jsx src/lib/libraries/extensions/index.jsx_orig
MICROBIT_MORE="\
    {${LF}\
        name: 'micro:bit MORE v0.4.3',${LF}\
