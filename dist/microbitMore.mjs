...
var EXTENSION_ID = 'https%253A%252F%252Fgithub.com%252Fyokobond%252Fscratch-microbit-more%252Fraw%252Fmaster%252Fdist%252FmicrobitMore.mjs';
/**
...
var extension = MbitMoreBlocks; // loadable-extension needs this line.

var _microbitMore = MbitMoreBlocks;
_microbitMore.extension = extension;
...
function formatMessage$1(config, state) {
  ...
  {
    browser$1(!react.isValidElement(config), '[React Intl] Don\'t pass React elements to ' + 'formatMessage(), pass `.props`.');
...
var entry = {
  ...
  extensionId: 'https%253A%252F%252Fgithub.com%252Fyokobond%252Fscratch-microbit-more%252Fraw%252Fmaster%252Fdist%252FmicrobitMore.mjs',
...
export { _microbitMore as __moduleExports, entry, extension };
